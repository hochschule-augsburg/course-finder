...
function toggleTheme() {
  ...
  theme.global.name = theme.global.current.dark ? 'customLightTheme' : 'customDarkTheme'
}
</script>
            ...
            <VListItem>
              ...
              <VDialog max-width="800">
                <template #activator="{ props: activatorProps }">
                  <VBtn v-bind="activatorProps" elevation="0" block>
                    {{ $t('Hilfe') }}
