...
en:
  ...
  login-text:
    Log in with you RZ-Account to register for courses. You can view courses
    without logging in.
  may-enroll-info: |
...
de:
  ...
  login-text:
    Melde dich mit deinem RZ-Account an, um dich für Kurse zu registrieren.
    Die Kursübersicht ist auch ohne Anmeldung verfügbar.
  may-enroll-info: |
